...
// "OO" changed to OOV4 to avoid conflicts with V3 Player which uses "OO"
...
(function(_, $) {
  ...
  var OoyalaVideoFactory = function() {
    ...
    this.features = [ OOV4.VIDEO.FEATURE.CLOSED_CAPTIONS,
                      OOV4.VIDEO.FEATURE.VIDEO_OBJECT_SHARING_GIVE ];
    this.technology = OOV4.VIDEO.TECHNOLOGY.HTML5;
    ...
    var getSupportedEncodings = function() {
      ...
      if (typeof videoElement.canPlayType === "function") {
        ...
        if ((!!videoElement.canPlayType("application/vnd.apple.mpegurl") ||
            ...
            !OOV4.isSmartTV && !OOV4.isRimDevice &&
            (!OOV4.isMacOs || OOV4.isMacOsLionOrLater)) {
    ...
    this.maxSupportedElements = (function() {
      var iosRequireSingleElement = OOV4.isIos;
      var androidRequireSingleElement = OOV4.isAndroid &&
                                        (!OOV4.isAndroid4Plus || OOV4.chromeMajorVersion < 40);
  ...
  var OoyalaVideoWrapper = function(domId, video, dimension, playerId) {
    ...
    this.setInitialTime = function(time) {
      ...
      var initialTimeRequired = OOV4.isSafari && videoEnded && time === 0;
      ...
      if (canSetInitialTime || initialTimeRequired) {
        ...
        if (OOV4.isAndroid || (initialTimeRequired && !OOV4.isIos)) {
